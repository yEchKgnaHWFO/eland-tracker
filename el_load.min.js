...
document.getElementsByTagName("head")[0].appendChild(b);break;default:document.getElementsByTagName("head")[0].appendChild(b)}};
ElandTracker.check=function(a,b){if("undefined"===typeof a.retriedTimes)a.retriedTimes=1;else{if(100<a.retriedTimes){"function"===typeof ElandTracker.callback&&ElandTracker.callback();return}a.retriedTimes+=1}ElandTracker.isAllReady()?"cf"===b?ElandTracker.ClickforceSendData(a):ElandTracker.sendData(a):(ElandTracker.delay(ElandTracker.check,a),setTimeout(ElandTracker.ready,100))};
