...
ElandTracker.storageAvailable=function(a){var d;try{if(d=window[a],!d)return!1}catch(f){return!1}try{return d.setItem("__storage_test__","__storage_test__"),d.removeItem("__storage_test__"),!0}catch(f){return!1}};
...
ElandTracker.getIframeUrl=function(a){function d(p){var b=new Date;b.setTime(b.getTime()+1E3);var a="expires\x3d"+b.toUTCString();p=p+"\x3d"+b.toDateString()+"; "+a+"; path\x3d/";document.cookie=p}function f(a){for(var b=document.cookie.split(";"),c=0;c<b.length;c++){var k=b[c];if(1<k.length)for(;" "===k.charAt(0);)k=k.substring(1);if(0===k.indexOf(a))return k.substring(a.length,k.length)}return""}function h(){for(var a=location.search.substring(1).split("\x26"),b=0;b<a.length;b++){var c=a[b].split("\x3d");
if("utm_medium"===c[0])try{return decodeURIComponent(c[1])}catch(k){return c[1]}}return""}function e(){for(var a=location.search.substring(1).split("\x26"),b=0;b<a.length;b++){var c=a[b].split("\x3d");if("utm_campaign"===c[0])try{return decodeURIComponent(c[1])}catch(k){return c[1]}}return""}function g(){for(var a=location.search.substring(1).split("\x26"),b=0;b<a.length;b++){var c=a[b].split("\x3d");if("utm_term"===c[0])try{return decodeURIComponent(c[1])}catch(k){return c[1]}}return""}function k(){for(var a=
...
ElandTracker.getIframe=function(a){var d=document.createElement("iframe");d.setAttribute("src",a);d.setAttribute("id","elandTracker");d.style.width="0px";d.style.height="0px";d.style.border="0px";d.style.display="none";d.setAttribute("alt","elandTracker");d.setAttribute("title","elandTracker");"function"===typeof ElandTracker.cbfunc&&d.setAttribute("onload","ElandTracker.cbfunc()");return d};
ElandTracker.sendData=function(a){var d;try{d=a.allowGAMeta}catch(f){d=1}sendMetaGooglePageView(d);a=ElandTracker.getIframeUrl(a);a=ElandTracker.getIframe(a);document.body.appendChild(a)};
...
ElandTracker.getClickForceIframeUrl=function(a){function d(a,d){var e=a.split("/"),g="";if(4<=e.length)for(var b=0;b<d;b++)if(4===e.length&&0===e[3].length){g="Web-Index";break}else if(e.length>3+b)g+=e[3+b]+"-";else break;else g="Web-Index";return g=g.split("?")[0]}function f(a){return a.toLowerCase().replace("\x3e","").replace("\x3c","").replace(";","").replace("script","").replace("alert","").replace("img","").replace("frame","").replace("input","").replace("title","").replace("body","")}var h=
...
h.BlackBerry()||h.iOS()||h.Opera()||h.Windows()||h.Puffin()||h.Other()}};this.subfolderDepth=a.trackSubfolderDepth?a.trackSubfolderDepth:1;this.target=a.targetType?a.targetType:"ad";this.url=a.url?a.url:f(location.href);this.referUrl=a.referUrl?a.referUrl:f(document.referrer);this.adSrTag=function(){for(var a=location.search.substring(1).split("\x26"),d=0;d<a.length;d++){var e=a[d].split("\x3d");if("AD_SR"==e[0]||"ad_sr"==e[0])return e[1]}return""}();a.cf_uid&&(this.cf_uid=a.cf_uid);for(var e=a.sp_variable.split(","),
...
function sendMetaGooglePageView(a){function d(a){function d(){dataLayerDMP.push(arguments)}var f=document.createElement("script");f.src="https://www.googletagmanager.com/gtag/js?id\x3d"+a+"\x26l\x3ddataLayerDMP";f.async=!0;document.head.appendChild(f);window.dataLayerDMP=window.dataLayerDMP||[];d("js",new Date);d("config",a);d("event","PageView",{send_to:a,user_id:e,client_id:e})}function f(a,d){var f=window.location.href;(function(a,d,b,c,e,f,g){a.fbq||(e=a.fbq=function(){e.callMethod?e.callMethod.apply(e,
arguments):e.queue.push(arguments)},a._fbq||(a._fbq=e),e.push=e,e.loaded=!0,e.version="2.0",e.queue=[],f=d.createElement(b),f.async=!0,f.src=c,g=d.getElementsByTagName(b)[0],g.parentNode.insertBefore(f,g))})(window,document,"script","https://connect.facebook.net/en_US/fbevents.js");0>f.indexOf("lat")&&0>f.indexOf("lng")&&(fbq("init",a,{external_id:e}),fbq("trackSingle",a.toString(),"PageView"));"function"===typeof d&&d()}var h=window.location.href;if(!"ipickup.com.tw cigna.com.tw toyota.com.tw taitung.gov.tw mercedes-me.tw feib.com.tw appbankee.com.tw cathay-ins.com.tw w3.bobe.com.tw kgibank.com.tw acerland.acer.com.tw mazda.com.tw volkswagen.com.tw nestlebaby.com.tw chailease.com.tw taishinbank.com.tw zztaitung.com ebank.megabank.com.tw iqueen.com.tw poyabuy.com.tw blueway-jeans.com bioderma-naos.com.tw m2.com.tw mart.family.com.tw drmay.com.tw beldora.com.tw so-nice.com.tw niceioi.com.tw shop.cosmed.com.tw fbshop.com.tw vincentsworld.com.tw tw.memebox.com lulus.tw shop.hengstyle.com timberland.com.tw freshdays-shop.com miniqueen.tw tw.istayreal.com anns.tw brashop.modemarie.com.tw store-philips.tw store.2ndstreet.com.tw w-ch.com.tw beautywa.tw armarpot.com mollifix.com eurohaus.com.tw cathaybk.com saime.com homeshop.taipei soloneshop.com.tw easyshop.com.tw lat\x3d lng\x3d".split(" ").some(function(a){return h.includes(a)})&&
0!==a){var e="";(function(){var a=window.location.href,d=new URLSearchParams;d.append("url",a);return fetch("https://dmp.eland-tech.com/dmpreceiver/getEdmpUuid?"+d.toString(),{credentials:"include"}).then(function(a){return a.json()}).then(function(a){e=a.edmp_uuid;return{edmpUuid:e}})})().then(function(a){e=a.edmpUuid;d("AW-10965005594");d("AW-1002649313");d("AW-10837221747");f(677954962557395);f(0x6c546d8d282fe);f(640155001270959);f(0x64ec4f191b6e)})}}
function getCookieValue(a){for(var d="",f=document.cookie.split(";"),h=0;h<f.length;h++){var e=f[h].trim();if(0===e.indexOf(a+"\x3d")){d=e.substring(a.length+1);break}}return d};