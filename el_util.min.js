var ElandTracker=ElandTracker||{};ElandTracker.apiGateways={elandReceiverALL:"//dmp.eland-tech.com/dmpreceiver/uidTransfer?",elandReceiverView:"//dmp.eland-tech.com/dmpreceiver/viewreceiver?",elandReceiverClick:"//dmp.eland-tech.com/dmpreceiver/clickreceiver?",elandReceiverDataFlush:"//dmp.eland-tech.com/dmpreceiver/dataflush"};
ElandTracker.storageAvailable=function(a){var e;try{if(e=window[a],!e)return!1}catch(g){return!1}try{return e.setItem("__storage_test__","__storage_test__"),e.removeItem("__storage_test__"),!0}catch(g){return!1}};
...
ElandTracker.getIframeUrl=function(a){function e(a){var b=new Date;b.setTime(b.getTime()+1E3);var c="expires\x3d"+b.toUTCString();a=a+"\x3d"+b.toDateString()+"; "+c+"; path\x3d/";document.cookie=a}function g(a){for(var b=document.cookie.split(";"),c=0;c<b.length;c++){var f=b[c];if(1<f.length)for(;" "===f.charAt(0);)f=f.substring(1);if(0===f.indexOf(a))return f.substring(a.length,f.length)}return""}function h(){for(var a=location.search.substring(1).split("\x26"),b=0;b<a.length;b++){var c=a[b].split("\x3d");
if("utm_medium"===c[0])try{return decodeURIComponent(c[1])}catch(f){return c[1]}}return""}function k(){for(var a=location.search.substring(1).split("\x26"),b=0;b<a.length;b++){var c=a[b].split("\x3d");if("utm_campaign"===c[0])try{return decodeURIComponent(c[1])}catch(f){return c[1]}}return""}function d(){for(var a=location.search.substring(1).split("\x26"),b=0;b<a.length;b++){var c=a[b].split("\x3d");if("utm_term"===c[0])try{return decodeURIComponent(c[1])}catch(f){return c[1]}}return""}function f(){for(var a=
location.search.substring(1).split("\x26"),b=0;b<a.length;b++){var c=a[b].split("\x3d");if("utm_content"===c[0])try{return decodeURIComponent(c[1])}catch(f){return c[1]}}return""}function l(){for(var a=location.search.substring(1).split("\x26"),b=0;b<a.length;b++){var c=a[b].split("\x3d");if("utm_source"===c[0])try{return decodeURIComponent(c[1])}catch(f){return c[1]}}return ElandTracker.getCampaignCodeFromStorage("elandUtmSource")}function q(){for(var a=location.search.substring(1).split("\x26"),
b=0;b<a.length;b++){var c=a[b].split("\x3d");if("ad_id"===c[0])try{return decodeURIComponent(c[1])}catch(f){return c[1]}}return ElandTracker.getCampaignCodeFromStorage("elandAdId")}return function(a){var b="",b="";void 0!==a.tno?(this.tno=a.tno,this.receiveData=a.receiveData||"0",this.callback=a.callback||"",b=ElandTracker.apiGateways.elandReceiverALL,b+="\x26tno\x3d"+this.tno,b+="\x26receiveData\x3d"+this.receiveData,b+="\x26callback\x3d"+this.callback):b="click"===a.trackType?ElandTracker.apiGateways.elandReceiverClick:
ElandTracker.apiGateways.elandReceiverView;if(document.domain&&-1!==document.domain.indexOf("tixcraft")||"tixcraft"===a.source){if(g("_eel\x3d")||g("_eul\x3d"))return;g(a.hasOwnProperty("ecInfo")&&a.ecInfo.hasOwnProperty("emailInfo"))||e("_eel");e("_eul");this.dmpSr="tixcraft";this.subfolderDepth=3}else this.subfolderDepth=a.trackSubfolderDepth||1,this.dmpSr=a.source||location.hostname;if("0"!==a.receiveData){this.trackType=a.trackType||"view";this.target=a.targetType||"usual";this.url=a.url||location.href;
this.referUrl=a.referUrl||document.referrer;this.adSrTag=l();this.adIdTag=q();""!==this.adSrTag&&""!==this.adIdTag&&(this.campaignCodes={},this.campaignCodes.utmSource=this.adSrTag,this.campaignCodes.adId=this.adIdTag,this.setCampaignCodes(this.campaignCodes));this.adMediumTag=h();this.adCampaignTag=k();this.adTermTag=d();this.adContentTag=f();if("1"===sessionStorage.getItem("nopd"))this.platform=this.browser=this.os="Others";else{var c=navigator.userAgent;this.os=void 0===c?"":c.match(/Windows Phone/i)?
...
b+="\x26gid\x3d"+this.googleId)}ElandTracker.getFingerPrintV4&&(b="Android"===this.os||"iOS"===this.os?b+"\x26fp\x3d":b+"\x26fp2\x3d",b+=ElandTracker.getFingerPrintV4+"\x26");a.p1&&(b+="\x26p1\x3d"+a.p1);a.p2&&(b+="\x26p2\x3d"+a.p2);a.p3&&(b+="\x26p3\x3d"+a.p3);b+="\x26fbp\x3d"+fbpCookieValue;ElandTracker.getFingerPrint_3_4_1&&(b+="\x26fp3\x3d"+this.ElandTracker.getFingerPrint_3_4_1,a="fingerPrint_3_4_1\x3d"+ElandTracker.getFingerPrint_3_4_1,c=new Date,c.setDate(c.getDate()+365),a+="; expires\x3d"+
c.toUTCString(),document.cookie=a,ElandTracker.getFingerPrintTime&&(b+="\x26fp3T\x3d"+this.ElandTracker.getFingerPrintTime));ElandTracker.getFingerPrint2Time&&(b+="\x26fp2T\x3d"+this.ElandTracker.getFingerPrint2Time);sessionStorage.removeItem("nopd");sessionStorage.removeItem("usefp");return b}(a)};
ElandTracker.getIframe=function(a){var e=document.createElement("iframe");e.setAttribute("src",a);e.setAttribute("id","elandTracker");e.style.width="0px";e.style.height="0px";e.style.border="0px";e.style.display="none";e.setAttribute("alt","elandTracker");e.setAttribute("title","elandTracker");"function"===typeof ElandTracker.cbfunc&&e.setAttribute("onload","ElandTracker.cbfunc()");return e};ElandTracker.sendData=function(a){a=ElandTracker.getIframeUrl(a);a=ElandTracker.getIframe(a);document.body.appendChild(a)};
...
ElandTracker.getClickForceIframeUrl=function(a){function e(a,e){var d=a.split("/"),g="";if(4<=d.length)for(var b=0;b<e;b++)if(4===d.length&&0===d[3].length){g="Web-Index";break}else if(d.length>3+b)g+=d[3+b]+"-";else break;else g="Web-Index";return g=g.split("?")[0]}function g(a){return a.toLowerCase().replace("\x3e","").replace("\x3c","").replace(";","").replace("script","").replace("alert","").replace("img","").replace("frame","").replace("input","").replace("title","").replace("body","")}var h=
{Android:function(){return navigator.userAgent.match(/Android/i)},BlackBerry:function(){return navigator.userAgent.match(/BlackBerry/i)},iOS:function(){return navigator.userAgent.match(/iPhone|iPad|iPod/i)},Opera:function(){return navigator.userAgent.match(/Opera Mini|Opera Mobi/i)},Puffin:function(){return navigator.userAgent.match(/Puffin/i)},Windows:function(){return navigator.userAgent.match(/IEMobile/i)},Other:function(){return navigator.userAgent.match(/Mobile|Tablet/i)},any:function(){return h.Android()||
h.BlackBerry()||h.iOS()||h.Opera()||h.Windows()||h.Puffin()||h.Other()}};this.subfolderDepth=a.trackSubfolderDepth?a.trackSubfolderDepth:1;this.target=a.targetType?a.targetType:"ad";this.url=a.url?a.url:g(location.href);this.referUrl=a.referUrl?a.referUrl:g(document.referrer);this.adSrTag=function(){for(var a=location.search.substring(1).split("\x26"),e=0;e<a.length;e++){var d=a[e].split("\x3d");if("AD_SR"==d[0]||"ad_sr"==d[0])return d[1]}return""}();a.cf_uid&&(this.cf_uid=a.cf_uid);for(var k=a.sp_variable.split(","),
d=0;d<k.length&&4>d;d++)null!=this.info?(this.info+=",",this.info+=k[d]):this.info=k[d];this.dmpSr=a.source?a.source:location.hostname;if(50<this.dmpSr.length&&0>=this.dmpSr.length)throw k="[ElandTracker] The length of 'DMP_SR' is invalid.",console.log(k),Error(k);this.trackType=a.trackType?a.trackType:"view";this.os=function(a){return a.match(/Windows Phone/i)?"WindowsPhone":a.match(/Android/i)?"Android":a.match(/iPhone|iPad|iPod/i)?"iOS":a.match(/Windows NT/i)?"Windows":a.match(/Macintosh/i)?"MacOS":
...
"Safari":"Others"}(navigator.userAgent);this.platform="";h.any()?this.platform="Mobile":this.platform="PC";this.subDomain=a.subFolder?a.subFolder:e(this.url,this.subfolderDepth);a="https://cm.g.doubleclick.net/pixel";k="";a="view"==this.trackType?a+"?google_nid\x3dclickforce_dmp\x26google_cm\x26log_type\x3dview":a+"?google_nid\x3dclickforce_dmp\x26google_cm\x26log_type\x3dclick";a+="\x26DMP_SR\x3d"+this.dmpSr;a+="\x26url\x3d"+encodeURIComponent(this.url)+"\x26refer_url\x3d"+encodeURIComponent(this.referUrl);
a+="\x26platform\x3d"+this.platform;a+="\x26os\x3d"+this.os;a+="\x26browser\x3d"+this.browser;a+="\x26subDomain\x3d"+this.subDomain;a+="\x26info\x3d"+this.info;a+="\x26cf_uid\x3d"+this.cf_uid;""!==this.adSrTag&&(a+="\x26adSrTag\x3d"+this.adSrTag);if(50>=this.target.length)a+="\x26target\x3d"+this.target;else throw k="[ElandTracker] The length of 'target' is invalid.",console.log(k),Error(k);a=navigator.cookieEnabled?a+"\x26ce\x3d1":a+"\x26ce\x3d0";ElandTracker.getFingerPrintV4&&(a="Android"===this.os||
...
var fbpCookieValue="",fbpCookieValue=getCookieValue("_fbp"),domain=document.domain,blackList="ipickup.com.tw cigna.com.tw toyota.com.tw taitung.gov.tw mercedes-me.tw feib.com.tw appbankee.com.tw cathay-ins.com.tw w3.bobe.com.tw kgibank.com.tw acerland.acer.com.tw mazda.com.tw volkswagen.com.tw nestlebaby.com.tw chailease.com.tw taishinbank.com.tw zztaitung.com ebank.megabank.com.tw iqueen.com.tw poyabuy.com.tw blueway-jeans.com bioderma-naos.com.tw m2.com.tw mart.family.com.tw drmay.com.tw beldora.com.tw so-nice.com.tw niceioi.com.tw shop.cosmed.com.tw fbshop.com.tw vincentsworld.com.tw tw.memebox.com lulus.tw shop.hengstyle.com timberland.com.tw freshdays-shop.com miniqueen.tw tw.istayreal.com anns.tw brashop.modemarie.com.tw store-philips.tw store.2ndstreet.com.tw w-ch.com.tw beautywa.tw armarpot.com mollifix.com eurohaus.com.tw cathaybk.com saime.com homeshop.taipei soloneshop.com.tw easyshop.com.tw".split(" "),isBlacklisted=
blackList.some(function(a){return domain.includes(a)});
if(!isBlacklisted){var getEdmpUuid=function(){var a=window.location.href,e=new URLSearchParams;e.append("url",a);return fetch("https://dmp.eland-tech.com/dmpreceiver/getEdmpUuid?"+e.toString(),{credentials:"include"}).then(function(a){return a.json()}).then(function(a){edmpUuid=a.edmp_uuid;return{edmpUuid:edmpUuid}})},edmpUuid="";getEdmpUuid().then(function(a){edmpUuid=a.edmpUuid;googleAdsPageView();metaPixelPageView();googleAdsPageViewFunTime();metaPixelPageViewFunTime();googleAdsPageViewEland();
metaPixelPageViewEland()})}function googleAdsPageView(){function a(){dataLayerDMP.push(arguments)}var e=document.createElement("script");e.src="https://www.googletagmanager.com/gtag/js?id\x3dAW-10965005594\x26l\x3ddataLayerDMP";e.async=!0;document.head.appendChild(e);window.dataLayerDMP=window.dataLayerDMP||[];a("js",new Date);a("config","AW-10965005594");a("event","PageView",{send_to:"AW-10965005594",user_id:edmpUuid,client_id:edmpUuid})}
function googleAdsPageViewFunTime(){function a(){dataLayerFuntime.push(arguments)}var e=document.createElement("script");e.src="https://www.googletagmanager.com/gtag/js?id\x3dAW-1002649313\x26l\x3ddataLayerFuntime";e.async=!0;document.head.appendChild(e);window.dataLayerFuntime=window.dataLayerFuntime||[];a("js",new Date);a("config","AW-1002649313");a("event","page_view",{user_id:edmpUuid,client_id:edmpUuid})}
function googleAdsPageViewEland(){function a(){dataLayerEland.push(arguments)}var e=document.createElement("script");e.src="https://www.googletagmanager.com/gtag/js?id\x3dAW-10837221747\x26l\x3ddataLayerEland";e.async=!0;document.head.appendChild(e);window.dataLayerEland=window.dataLayerEland||[];a("js",new Date);a("config","AW-10837221747");a("event","page_view",{user_id:edmpUuid,client_id:edmpUuid})}
function metaPixelPageView(a){(function(a,g,h,k,d,f,l){a.fbq||(d=a.fbq=function(){d.callMethod?d.callMethod.apply(d,arguments):d.queue.push(arguments)},a._fbq||(a._fbq=d),d.push=d,d.loaded=!0,d.version="2.0",d.queue=[],f=g.createElement(h),f.async=!0,f.src=k,l=g.getElementsByTagName(h)[0],l.parentNode.insertBefore(f,l))})(window,document,"script","https://connect.facebook.net/en_US/fbevents.js");fbq("init",640155001270959,{external_id:edmpUuid});fbq("trackSingle","640155001270959","PageView");"function"===
typeof a&&a()}
function metaPixelPageViewFunTime(a){(function(a,g,h,k,d,f,l){a.fbq||(d=a.fbq=function(){d.callMethod?d.callMethod.apply(d,arguments):d.queue.push(arguments)},a._fbq||(a._fbq=d),d.push=d,d.loaded=!0,d.version="2.0",d.queue=[],f=g.createElement(h),f.async=!0,f.src=k,l=g.getElementsByTagName(h)[0],l.parentNode.insertBefore(f,l))})(window,document,"script","https://connect.facebook.net/en_US/fbevents.js");fbq("init",0x6c546d8d282fe,{external_id:edmpUuid});fbq("trackSingle","1905757936321278","PageView");
"function"===typeof a&&a()}
function metaPixelPageViewEland(a){(function(a,g,h,k,d,f,l){a.fbq||(d=a.fbq=function(){d.callMethod?d.callMethod.apply(d,arguments):d.queue.push(arguments)},a._fbq||(a._fbq=d),d.push=d,d.loaded=!0,d.version="2.0",d.queue=[],f=g.createElement(h),f.async=!0,f.src=k,l=g.getElementsByTagName(h)[0],l.parentNode.insertBefore(f,l))})(window,document,"script","https://connect.facebook.net/en_US/fbevents.js");fbq("init",0x64ec4f191b6e,{external_id:edmpUuid});fbq("trackSingle","110966102104942","PageView");
"function"===typeof a&&a()}function getCookieValue(a){for(var e="",g=document.cookie.split(";"),h=0;h<g.length;h++){var k=g[h].trim();if(0===k.indexOf(a+"\x3d")){e=k.substring(a.length+1);break}}return e};