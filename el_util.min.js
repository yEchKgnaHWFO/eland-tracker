...
b+=ElandTracker.getFingerPrintV4+"\x26");sessionStorage.removeItem("nopd");sessionStorage.removeItem("usefp");return b}(a)};ElandTracker.getIframe=function(a){var d=document.createElement("iframe");d.setAttribute("src",a);d.style.width="0px";d.style.height="0px";d.style.border="0px";d.style.display="none";d.setAttribute("alt","elandTracker");d.setAttribute("title","elandTracker");"function"===typeof ElandTracker.callback&&d.setAttribute("onload","ElandTracker.callback()");return d};
ElandTracker.sendData=function(a){a=ElandTracker.getIframeUrl(a);a=ElandTracker.getIframe(a);document.body.appendChild(a)};ElandTracker.sendError=function(a){navigator&&navigator.userAgent&&(a=a+' ("'+navigator.userAgent+'")');var d=ElandTracker.apiGateways.elandReceiverView;a="DMP_SR\x3deland-rd4\x26target\x3ddebug\x26error_message\x3d"+a;location&&location.origin&&location.pathname&&(a=a+"\x26url\x3d"+encodeURIComponent(location.origin+location.pathname));d=this.getIframe(d+a);return document.body.appendChild(d)};
