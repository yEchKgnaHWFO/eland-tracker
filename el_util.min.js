...
ElandTracker.getIframeUrl=function(a){function d(l){var b=new Date;b.setTime(b.getTime()+1E3);var c="expires\x3d"+b.toUTCString();l=l+"\x3d"+b.toDateString()+"; "+c+"; path\x3d/";document.cookie=l}function f(l){for(var b=document.cookie.split(";"),c=0;c<b.length;c++){var a=b[c];if(1<a.length)for(;" "===a.charAt(0);)a=a.substring(1);if(0===a.indexOf(l))return a.substring(l.length,a.length)}return""}function h(){for(var a=location.search.substring(1).split("\x26"),b=0;b<a.length;b++){var c=a[b].split("\x3d");
